...
console.log('🔧 Fix Vercel Private Key Format');
console.log('================================');
...
try {
  ...
  // The key should already be properly formatted, but let's ensure it's correct
  ...
  // For Vercel, we need to replace actual newlines with \n
  ...
  console.log('3. Click Edit and DELETE the entire current value');
  console.log('4. Copy and paste the EXACT key above (including the \\n characters)');
  console.log('5. Save and wait for redeploy');
  console.log('\n⚠️  IMPORTANT: The key must have \\n characters, not actual newlines!');
